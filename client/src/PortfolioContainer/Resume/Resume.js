...
const Resume = (props) => {
  ...
  const resumeDetails = [
    <div className="resume-screen-container" key="education">
      <ResumeHeading
        heading={"National Institute of Technology, Warangal"}
        subHeading={"MASTERS OF TECHNOLOGY"}
        fromDate={"2019"}
        toDate={"2021"}
      />
    ...
    <div className="resume-screen-container" key="interests">
      ...
      <ResumeHeading
        heading="Cricket"
        description="Following cricket is something i can never compromise with, skimming through Spotify's pop songs charts is at times the best stress reliever that i can get my hands on."
      />
      <ResumeHeading
